...
//                it.putExtra("time",timeButton.getText());
                it.putExtra("price", tvTotal.getText().toString());  // Pass the price as a string
                it.putExtra("date", dateButton.getText().toString());  // Pass the date as a string
                it.putExtra("time", timeButton.getText().toString());  // Pass the time as a string
                startActivity(it);
            }
        });
