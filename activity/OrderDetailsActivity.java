...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lst = findViewById(R.id.listViewBM);  // Ensure 'lst' is the correct ID for your ListView
        btn = findViewById(R.id.buttonBMBack);  // Ensure 'btn' is the correct ID for your Button
